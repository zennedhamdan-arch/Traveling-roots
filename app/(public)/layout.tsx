 ...
 * every page inside it — /, /order, /privacy, /terms — gets the navbar, and
 * nothing under /admin ever does, without a pathname check in a server
 * component (which the App Router does not support) or a client-side hack.
 */
